        ...
        <div class="table_desc">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="product_remove"><a href="{{URL::to('/delete-to-cart/'.$v_content->rowId)}}"><i class="fas fa-trash" onclick="return confirm('Bạn có chắc muốn xóa sản phẩm {{$v_content->name}} không?')"></i></a></td>
                </tr>
                @endforeach   
            </tbody>
        </table>   
